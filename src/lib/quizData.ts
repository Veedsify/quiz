...
export const quizData: Section[] = [
  ...
  },
  {
    ...
    criteria: [
      ...
      {
        description: "Insurance advice",
        points: 2.5,
        inputType: "binary",
        options: ["Yes", "No"],
      },
      {
        description: "Ingestion safety",
        points: 2.5,
        inputType: "binary",
        options: ["Yes", "No"],
      },
      {
        description: "Insects (Bite Prevention)",
        points: 2.5,
        inputType: "binary",
        options: ["Yes", "No"],
      },
      ...
      {
        description: "Infection (hand washing, face masks)",
        points: 2.5,
        inputType: "binary",
        options: ["Yes", "No"],
      },
      {
        description: "Information as needed",
        points: 2.5,
        inputType: "binary",
        options: ["Yes", "No"],
      },
